...
这份 Skill 的目标很明确：让中文技术写作更克制、更准确、更易读。它不追求宣传感，也不试图把所有内容都写成统一模板，而是聚焦几类高频问题：
...
如果正在寻找一套适合中文技术文档的基础写作规范，这份 Skill 可以直接拿来用。
